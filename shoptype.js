...
let st_cosell_screen = `<div class="st-cosell-link-mask" id="st-cosell-intro-mask" style="display:none" onclick="hideElement(this)"><div class="st-cosell-links" onclick="event.stopPropagation()"><div class="st-cosell-links-header" id="st-cosell-links-header">{{site}} is proud to introduce &quot;Cosell&quot;, a unique attribution based engine, to boost the influencer in you<br><span class="st-cosell-links-header-span">Make money, while you spend money</span></div><div class="st-cosell-body"><div class="st-cosell-steps-div"><div class="st-cosell-exp"><div class="st-cosell-exp-header-div"><h3 class="st-cosell-exp-header">How does it work?</h3></div><div class="st-cosell-exp-steps"><div class="st-cosell-step"><div class="st-cosell-step-no st-cosell-step-overlay">1</div><div class="st-cosell-step-img-div"><img src="https://in.awake.market/wp-content/themes/marketo/assets/images/Phone-Register.png" loading="lazy" alt="" class="st-cosell-step-img"></div><div class="st-cosell-step-title">Sign up as a Coseller</div></div><div class="st-cosell-step"><div class="st-cosell-step-no st-cosell-step-overlay">2</div><div class="st-cosell-step-img-div"><img src="https://in.awake.market/wp-content/themes/marketo/assets/images/Phone-Product.png" loading="lazy" alt="" class="st-cosell-step-img"></div><div class="st-cosell-step-title">Click on the Cosell Button</div></div><div class="st-cosell-step"><div class="st-cosell-step-no st-cosell-step-overlay">3</div><div class="st-cosell-step-img-div"><img src="https://in.awake.market/wp-content/themes/marketo/assets/images/Phone-Register.png" loading="lazy" alt="" class="st-cosell-step-img"></div><div class="st-cosell-step-title">Share unique link on your social media</div></div></div></div><div class="st-cosell-signup"><div class="st-cosell-sugnup-btn" onclick="showLogin()">Proceed to Register</div></div></div><div class="st-cosell-adv"><div class="st-cosell-step-pts"><div class="st-cosell-step-no">1</div><div class="st-cosell-step-txt">Coseller subscription is free, no strings attached!</div></div><div class="st-cosell-step-pts"><div class="st-cosell-step-no">2</div><div class="st-cosell-step-txt">&quot;Cosell&quot; has been introduced to many online marketplaces, your coseller profile is not limited to one website</div></div><div class="st-cosell-step-pts"><div class="st-cosell-step-no">3</div><div class="st-cosell-step-txt">Cosell link is unique to you. Share it wherever, the attribution money comes only to you!</div></div></div></div><div class="st-cosell-links-footer"><div class="st-cosell-footer-shoptype">Powered by <a href="https://www.shoptype.com" target="_blank" class="st-cosell-footer-shoptype-link">Shoptype</a></div> <a href="#" target="_blank" class="st-link-block"><div class="st-cosell-page-txt">Learn more about Coselling</div> </a></div></div></div>`;
